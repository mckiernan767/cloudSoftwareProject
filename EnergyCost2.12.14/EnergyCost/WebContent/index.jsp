        ...
        <script>
            $(document).ready(function() {                        
                $('#submit').click(function(event) {  
                 ...
                 $.get('ActionServlet',{eventStart:start, eventID:id},function(responseText) { 
...
<select name='drivers' ><option>Please select a host:</option>
 ...
 <br> <br>
    ...
    <input type="button" value="Submit"> &nbsp; &nbsp;
     ...
     <label>Intial cost: <input type="text" value ="<%=energyCost%>" name="intialCost" id="initialCost" readonly /> </label>
     <label>Change in cost: <div id="newCost">  </div></label>
<div id="welcometext">
</div>     
...
<table class="table table-bordered">
	...
	<tbody>
		...
		<%
			...
			//System.out.println(ganttChartString);
